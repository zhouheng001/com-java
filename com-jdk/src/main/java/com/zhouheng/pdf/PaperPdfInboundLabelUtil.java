 ...
 */
public class PaperPdfInboundLabelUtil {
    ...
    public static String writeExampaperPdf() throws IOException,
        ...
        //输出路径
        String outPath = "/Users/zhouheng/chj/data/pdf/入库单打签.pdf";
    ...
    private static PdfPTable createTable(PdfPTable table) throws DocumentException, IOException {
        ...
        PdfPCell cell1 = createPdfCellTitleContent(new Paragraph("入库单号" + "\n" + "Order No.", TextNameFont));
        table.addCell(cell1);
        ...
        // 第二行
        PdfPCell cell2 = createPdfCellTitleContent(new Paragraph("箱号" + "\n" + "Carton No.", TextNameFont));
        table.addCell(cell2);
        ...
        // 第四行
        PdfPCell cell10 = createPdfCellTitleContent(new Paragraph("入库标签号" + "\n" + "Inbound Lable No.", TextNameFont));
        ...
        PdfPCell cell23 = createPdfCellTitleContent(new Paragraph("收货单号" + "\n" + "ASN", TextNameFont));
        table.addCell(cell23);

        PdfPCell cell24 = createPdfCellValueContent(new Paragraph("ASN20123123", TextValueFont));
